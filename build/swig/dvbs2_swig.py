...
class bbheader_bb(object):
    ...
    def make(framesize, rate, rolloff, issyiparam, npdparam):
        """make(gr::dvbs2::dvbs2_framesize_t framesize, gr::dvbs2::dvbs2_code_rate_t rate, gr::dvbs2::dvbs2_rolloff_factor_t rolloff, gr::dvbs2::dvbs2_issyiparam_t issyiparam, gr::dvbs2::dvbs2_npd_t npdparam) -> bbheader_bb_sptr"""
        return _dvbs2_swig.bbheader_bb_make(framesize, rate, rolloff, issyiparam, npdparam)
...
def bbheader_bb_make(framesize, rate, rolloff, issyiparam, npdparam):
    """bbheader_bb_make(gr::dvbs2::dvbs2_framesize_t framesize, gr::dvbs2::dvbs2_code_rate_t rate, gr::dvbs2::dvbs2_rolloff_factor_t rolloff, gr::dvbs2::dvbs2_issyiparam_t issyiparam, gr::dvbs2::dvbs2_npd_t npdparam) -> bbheader_bb_sptr"""
    return _dvbs2_swig.bbheader_bb_make(framesize, rate, rolloff, issyiparam, npdparam)
...
class bbheader_bb_sptr(object):
    ...
    def make(self, framesize, rate, rolloff, issyiparam, npdparam):
        """make(bbheader_bb_sptr self, gr::dvbs2::dvbs2_framesize_t framesize, gr::dvbs2::dvbs2_code_rate_t rate, gr::dvbs2::dvbs2_rolloff_factor_t rolloff, gr::dvbs2::dvbs2_issyiparam_t issyiparam, gr::dvbs2::dvbs2_npd_t npdparam) -> bbheader_bb_sptr"""
        return _dvbs2_swig.bbheader_bb_sptr_make(self, framesize, rate, rolloff, issyiparam, npdparam)
